...
@implementation ViewSequenceView
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    ...
    return [[[Data sharedInstance] Sequence] count];
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    // Return the number of rows in the section.
    return [[[[[Data sharedInstance] Sequence] objectAtIndex:section] objectForKey:@"data"] count];
}
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    header.title.text = [[[[Data sharedInstance] Sequence] objectAtIndex:section] objectForKey:@"header"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setUpCell:[[[[[Data sharedInstance] Sequence] objectAtIndex:indexPath.section] objectForKey:@"data"] objectAtIndex:indexPath.row]];
